...
public class PilotoController {
    ...
    public ModelAndView eliminarPiloto(@PathVariable Integer dorsal, HttpServletRequest request, RedirectAttributes redirectAttributes) {
        ...
        try {
            ...
            Long idEquipo = piloto.getEquipo().getId();

            pilotoService.eliminarPiloto(dorsal);
            redirectAttributes.addFlashAttribute("mensaje", "El piloto ha sido eliminado exitosamente.");
            mv.setViewName("redirect:/equipos/" + idEquipo);
            ...
            logger.error("No se puede eliminar el piloto con dorsal: {}", dorsal);
            mv.setViewName("error");
            mv.addObject("mensajeError", e.getMessage());
        } catch (Exception e) {
